...
--------------------
BTN_ID_DOC_NEW = {
   pos = {x="window_width - BTN_ID_DOC_NEW.size.width", y="BTN_ID_DOC_NEW.size.height*2 - BTN_ID_DOC_NEW.size.height*1.2"},
...
BTN_ID_DOC_SAVE = {
    pos = {x="window_width - BTN_ID_DOC_SAVE.size.width", y="BTN_ID_DOC_SAVE.size.height*2 + BTN_ID_DOC_SAVE.size.height*1.2"},
    size = {width="40", height="40"}
}
--------------------
